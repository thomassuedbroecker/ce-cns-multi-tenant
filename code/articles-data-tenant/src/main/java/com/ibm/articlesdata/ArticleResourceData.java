...
public class ArticleResourceData {
    ...
    private String tenantJSONWebToken(){
        try {
            ...
            System.out.println("-->log: com.ibm.articles.ArticlesDataAccess.tenantJSONWebToken scope: " + scope.toString());
            System.out.println("-->log: com.ibm.articles.ArticlesResourceData.tenantJSONWebToken access token: " + this.accessToken.toString());
